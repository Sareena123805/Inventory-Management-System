...
<body>
  ...
  <h1>Customer Details</h1>
   <h2> No of customers are:
  <%
  List<Customer>lstCustomers = (List<Customer>) request.getAttribute("lstCustomer");
  out.print(lstCustomers.size());
  %>
 ...
 if(lstCustomer!=null){
   for(Customer cust : lstCustomer){
     %>
     <tr>
     <td><%= cust.getC_Fname() %></td>
     <td><%= cust.getC_Lname() %></td>
     <td><%= cust.getC_Address() %></td>
     </tr>
     <%
   }
 }else{
