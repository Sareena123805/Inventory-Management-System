...
<%@page import="controller.SalesController" %>
<!DOCTYPE html>
  ...
  <div class="sidebar">
    ...
    <section class="home-section">
       ...
       <form action="<%=request.getContextPath()%>/SalesController"
            ...
            <table>
        <tr> <td> Product Name</td><td> <input type="text" name=sl_ProductName></td></tr>
        <tr> <td> Quantity</td><td> <input type="Number" name=sl_ProductQTY></td></tr>
        <tr> <td> Price</td><td> <input type="Number" name=sl_Price></td></tr>
        <tr> <td> Date</td><td> <input type="date" name=s_Date></td></tr>
